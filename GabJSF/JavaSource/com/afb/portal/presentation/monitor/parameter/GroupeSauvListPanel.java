 ...
 *
 */
public class GroupeSauvListPanel extends AbstractPanel{


	private String txtparam;
	
	private GroupeSauvDialog  dialog;
	
	private List<GroupeSauv> values = new ArrayList<GroupeSauv>();

	/**
	 * contructeur
	 */
	public GroupeSauvListPanel() {
		super();
	}
	 ...
	 * @return the dialog
	 */
	public GroupeSauvDialog getDialog() {
		return dialog;
	}
	 ...
	 */
	public void setDialog(GroupeSauvDialog dialog) {
		this.dialog = dialog;
	}
	 ...
	 * @return the values
	 */
	public List<GroupeSauv> getValues() {
		return values;
	}
	 ...
	 */
	public void setValues(List<GroupeSauv> values) {
		this.values = values;
	}
	...
	public String getFileDefinition() {
		...
		return "/views/parameter/GroupeSauvListPanel.xhtml";
	}
	...
	public String getTitle() {
		...
		return "GroupeSauvListPanel.title";
	}
	...
	protected void initComponents() {
		...
		try {
			...
			values = new ArrayList<GroupeSauv>();
	...
	public void validateSubDialogClosure(IDialog child, DialogFormMode mode,
		...
		GroupeSauv currentObject = child.getCurrentObject();
	...
	public void processSearch() {
		...
		try {
			...
			// Methode de filtre
			this.values = ViewHelper.dao.filter(GroupeSauv.class,null,rc,null,null,0,-1);

			// Si la liste est nulle
			if(this.values == null) this.values = new ArrayList<GroupeSauv>();
	...
	public void processCreate() {
		...
		try {
			...
			dialog = new GroupeSauvDialog(DialogFormMode.CREATE, new GroupeSauv(), this);
			// Ouverture
	...
	public void processUpdate() {
		...
		GroupeSauv value = this.values.get(index);

		try {

			// Instanciation 
			dialog = new GroupeSauvDialog(DialogFormMode.UPDATE, value, this);
