...
public class Transactions  implements ITransactions{
	...
	public void creerTimer(){
		...
		try{
			...
			String times =  repportManager.findTimeTransaction();
	...
	public void process(User user,Date datedebut, Date datefin){
		...
		rapportJourMonitoringTPE.processTransactions(user, datedebut, datefin);
	}
	...
	public void process(){
		...
		rapportJourMonitoringTPE.processTransactions(null, datedebut, datefin);
		creerTimer();
	}
