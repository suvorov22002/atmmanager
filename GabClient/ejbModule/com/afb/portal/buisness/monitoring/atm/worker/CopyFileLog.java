 ...
 */
// extends Thread
public class CopyFileLog implements Serializable{
	 ...
	 * @param sauv
	 */
	public CopyFileLog(File srcFile,String atmName,GroupeSauv sauv,Atm atm){
	...
	public Boolean CopyFile(){
		...
		try{
			...
			e1.printStackTrace();	
			AccessDirectorieFileJOURNAL(atm);
	...
	public static boolean AccessDirectorieFileJOURNAL(Atm value){
