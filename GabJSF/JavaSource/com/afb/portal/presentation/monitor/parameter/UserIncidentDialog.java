 ...
 * @version 1.0
 */
public class UserIncidentDialog extends AbstractDialog{
	 ...
	 */
	public UserIncidentDialog(DialogFormMode mode, TypeIncident currentObject, IViewComponent parent) {
	...
	public String getFileDefinition() {
		...
		return "/views/parameter/UserIncidentDialog.xhtml";
	...
	public void initComponents() {
		...
		try{
			...
			currentObject = ViewHelper.dao.findByPrimaryKey(TypeIncident.class, currentObject.getId(),null);
	 ...
	 */
	public void setCurrentObject(TypeIncident currentObject) {
		this.currentObject = currentObject;
	}
