 ...
 * @version 1.0
 */
public class TPEDialog extends AbstractDialog{
	 ...
	 */
	public TPEDialog(DialogFormMode mode, Atm currentObject, IViewComponent parent) {
	...
	protected void validate(){
		...
		this.currentObject.setTypeAtm(AtmStatus.TPE);
