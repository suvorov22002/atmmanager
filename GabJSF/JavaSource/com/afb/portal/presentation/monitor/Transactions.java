...
public class Transactions extends AbstractDialog{
	...
	public void process(){
		...
		try{
			...
			if(user != null)ViewHelper.transactions.process(user,datedebut,datefin);
	...
	public String getFileDefinition() {
		// TODO Auto-generated method stub
		return "/views/parameter/TransactionsDialog.xhtml";
	}
