 ...
 * @version 1.0
 */
public class GroupSauvConverter implements Converter{
	...
	public Object getAsObject(FacesContext arg0, UIComponent arg1, String submittedValue) {
		...
		GroupeSauv val = ViewHelper.atm.findByPrimaryKey(GroupeSauv.class, Long.valueOf(submittedValue), null);
	...
	public String getAsString(FacesContext arg0, UIComponent arg1, Object arg2){
		...
		if(arg2 instanceof GroupeSauv){
			
			// Recuperation de l'utilisateur
			GroupeSauv val = (GroupeSauv)arg2;
